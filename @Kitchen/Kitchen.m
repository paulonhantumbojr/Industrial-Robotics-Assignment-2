classdef Kitchen < handle
    ...
    methods
        ...
        dishwasher_h = PlaceObject('dishwasher.PLY',[-1.110,0.125,-2.8]); % [-1.125,0.125,-2.8]
        ...
        rack_h = PlaceObject('dishrack.PLY',[0.375,-2.05,1.015]); %[0.2375,-2.215,1.05]
...
%         hand_h = PlaceObject('hand.PLY',[-0.75,-1.0,1.5]); % [-0.75,-1.0,1.5]
%         verts = [get(hand_h ,'Vertices'), ones(size(get(hand_h ,'Vertices'),1),1)] * trotx(pi/2) * trotz(pi);
%         set(hand_h ,'Vertices',verts(:,1:3))
