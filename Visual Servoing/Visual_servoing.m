...
% Generate pates
 ...
 platePosition = [0.75,-1.6; ... % Plate 1 position
...
pStar = [550 475 475 550; 475 475 550 550]; % Points of the plate (Target)

%Create 3D points
P = [0.975,0.975,1.1,1.1;
-1.25,-1.25,-1.25,-1.25;
 1.1,1.225,1.1,1.225]; % difference between y and z coordinates should be similar
