...
%% Load the environment in the world
 ...
 plate_h = PlaceObject('plate.PLY',[0.265,-1.91,1.125]); % [-0.75,-1.0,1.5]
...
% pStar = [325 200 200 325; 200 200 325 325]; % Points of the plate (Target)
pStar = [325 200 200 325; 250 250 375 375]; % Points of the plate (Target)
...
% Make a UR3
ur3BaseTransform = [0.85,-2.125,1.0]; % UR3 Base position [0.7,-1.875,1.0]
myUR3 = ModifiedUR3(ur3BaseTransform);  
myUR3.PlotAndColourUR3Robot()

%Initial pose
% q0 = deg2rad([90;-60;60;0;0;0]); % q0 = [pi/2; -pi/3; -pi/3; -pi/6; 0; 0];
...
ksteps = 0;
 while true
        ...
        Jinv = pinv(J2);  % ? difference between inv and pinv
        qp = Jinv*v;
